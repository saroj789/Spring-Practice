 ...
 */
@WebServlet("/SearchDocument_New")
public class SearchDocument_New extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchDocument_New() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			StatusBean validationBean = validations.validateViewData(Field1,Field2,sessionId,Field1,Field1,Field1);
			...
			if(validationBean.getStatus().equals(Constants.FAILSTATUSSTRING)) {
				...
				//docList=viewDocHelper.getDocument_New(Field1, Field2);
